...
The new cue-management, proactive-follow-up, and chat-source surfaces also passed a real Windows display smoke at DPR `1.25`: logical sizes were `1500 x 1080`, `900 x 760`, and `520 x 680`, with no clipping or private cue text in the desktop bubble. No provider or credential access occurred. Exact-SHA test-only CI evidence is recorded in [desktop/P7H-ACCEPTANCE.md](desktop/P7H-ACCEPTANCE.md). P8 remains unstarted and separate from this work.
