...
async def use_builtin_service(data: BuiltinServiceRequest):
    built_in_config = InputData(
        ...
        whisper_api_key=os.environ.get("WHISPER_API_KEY", os.environ.get("LLM_API_KEY", "")),
        llm_base_url=os.environ.get("LLM_BASE_URL", ""),
        whisper_base_url=os.environ.get("WHISPER_BASE_URL", os.environ.get("LLM_BASE_URL", "")),
        whisper_model=os.environ.get("WHISPER_MODEL", "mimo-v2.5-asr"),
        ai_model=data.ai_model or os.environ.get("LLM_MODEL", "mimo-v2.5-pro"),
        tts_api_key=os.environ.get("TTS_API_KEY", os.environ.get("LLM_API_KEY", "")),
        tts_voice_id=os.environ.get("TTS_VOICE_ID", "冰糖"),
